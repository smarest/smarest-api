...
type RestaurantProductFactory struct{}

func NewRestaurantProductFactory() RestaurantProductFactory {
	return RestaurantProductFactory{}
}

func (f *RestaurantProductFactory) CreateList(items []Product, fields string) []interface{} {
...
func (f *RestaurantProductFactory) Create(item *Product, fields string) map[string]interface{} {
